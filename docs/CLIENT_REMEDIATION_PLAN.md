...
- Implemented and remote-CI verified: #30, #38, #39, and #45.
...
|  38 | Card payoff/interest calculator: **Implemented and remote-CI verified.** API and Mobile use matching BigInt monthly-basis-point calculations, half-up minor-unit rounding, explicit inputs, non-payoff outcomes, and a 1,200-month ceiling.                                                                                      | M/B/DB/API/Biz/UI. Golden tests cover zero balance/interest, ×100 scale, insufficient payment, multi-month/final rounding, and ceiling behavior. Phase 14 production binding remains separate.       | Released in `812935f2e7be1b8054070d3155c13e770c63e3eb`; Backend Foundation run `34018736375` passed every required job.                                                                                                                                                                      |
|  39 | Card statement terms: **Implemented and remote-CI verified.** Nullable statement/due days, monthly rate basis points, and minimum payment minor units round-trip through DB/API/sync/Mobile; non-card values reject or clear.                                                                                                | M/B/DB/API/Biz/UI. DB/API/Mobile tests cover 1–28 bounds, legacy nulls, ownership, type clearing, sync, local-time reminders, policy routing, and payload privacy.                                    | Released in the same Slice 3 SHA/run. Phase 11 reminder creation is proven; APNs/FCM/SMTP and physical-device acceptance remain genuine external gates.                                                                                                                                     |
...
- [x] Release #38/#39: scoped Slice 3 SHA `812935f2e7be1b8054070d3155c13e770c63e3eb` passed Backend Foundation run `34018736375` after local DB/API/sync/Mobile/Admin and review gates.
