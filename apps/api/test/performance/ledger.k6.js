...
export const options = {
  scenarios: {
    ...
    mutations: { executor: 'constant-vus', vus: 5, duration: '30s', exec: 'mutate' },
    contention: { executor: 'constant-vus', vus: 8, duration: '30s', exec: 'contend' },
    reconciliation: { executor: 'constant-vus', vus: 2, duration: '30s', exec: 'reconcile' },
  },
  thresholds: {
    checks: ['rate==1'],
    ...
    ledger_search_duration_ms: ['p(50)<25', 'p(95)<50', 'p(99)<300'],
    ledger_account_duration_ms: ['p(50)<150', 'p(95)<300', 'p(99)<600'],
    ledger_create_duration_ms: ['p(50)<75', 'p(95)<150', 'p(99)<800'],
    ledger_transfer_duration_ms: ['p(50)<100', 'p(95)<150', 'p(99)<1000'],
