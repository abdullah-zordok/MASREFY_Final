...
export const SECURITY_ROUTES: readonly SecurityRouteDefinition[] = Object.freeze([
  ...
  ['POST','api/v1/admin/access/admins/:userId/disable','disableAdmin',200,'admin-team.disable',true],
  ['POST','api/v1/admin/access/admins/:userId/sessions/revoke','revokeAdminSessions',200,'admin-team.sessions.revoke',true],
  ['GET','api/v1/admin/access/invitations','listAdminInvitations',200,'admin-team.read'],
  ['POST','api/v1/admin/access/invitations','createAdminInvitation',201,'access.invites.write',true],
  ...
  ['POST','api/v1/admin/access/assignments','assignAdminRole',201,'access.assignments.write',true],
  ['DELETE','api/v1/admin/access/assignments/:assignmentId','revokeAdminRole',204,'access.assignments.write',true],
  ['GET','api/v1/admin/access/permissions','listPermissions',200,'permissions.read'],
  ['GET','api/v1/admin/support-access/requests','listSupportAccessRequests',200,'support.access.read'],
  ['POST','api/v1/admin/support-access/requests','createSupportAccessRequest',201,'support.access.request'],
  ['GET','api/v1/admin/support-access/requests/:requestId','getSupportAccessRequest',200,'support.access.read'],
  ['POST','api/v1/admin/support-access/requests/:requestId/decision','decideSupportAccessRequest',200,'support.access.approve',true],
  ['POST','api/v1/admin/support-access/requests/:requestId/revoke','revokeSupportAccess',200,'support.access.revoke',true],
  ['GET','api/v1/admin/support-access/requests/:requestId/workspace','getSupportWorkspace',200,'support.access.use'],
  ['POST','api/v1/admin/support-access/requests/:requestId/end','endSupportAccess',200,'support.access.use'],
  ['GET','api/v1/me/support-access/requests','listMySupportAccessRequests',200],
  ['POST','api/v1/me/support-access/requests/:requestId/decision','decideMySupportAccessRequest',200],
  ...
  ['GET','api/v1/admin/security/incidents','listSecurityIncidents',200,'security.incidents.manage'],
  ['POST','api/v1/admin/security/incidents','createSecurityIncident',201,'security.incidents.manage',true],
  ['GET','api/v1/admin/security/incidents/:incidentId','getSecurityIncident',200,'security.incidents.manage'],
  ['PATCH','api/v1/admin/security/incidents/:incidentId','updateSecurityIncident',200,'security.incidents.manage',true],
  ...
  ['POST','api/v1/admin/privacy/exports/:exportId/actions','actOnPrivacyExport',200,'privacy.exports.manage',true],
  ['GET','api/v1/admin/privacy/deletions','listDeletionRequests',200,'privacy.deletions.read'],
  ['POST','api/v1/admin/privacy/deletions/:deletionId/actions','actOnDeletionRequest',200,'privacy.deletions.manage',true],
  ['GET','api/v1/admin/retention/policies','listRetentionPolicies',200,'retention.read'],
  ['PATCH','api/v1/admin/retention/policies/:policyId','updateRetentionPolicy',200,'retention.write',true],
  ['POST','api/v1/admin/retention/holds','createRetentionHold',201,'retention.write',true],
  ['DELETE','api/v1/admin/retention/holds/:holdId','releaseRetentionHold',204,'retention.write',true],
].map(([method, path, operation, status, permission, recentMfa]) => ({
  method, path, operation, status, permission, recentMfa,
}) as SecurityRouteDefinition));

@Controller()
export class SecurityController {
  constructor(private readonly security: SecurityService, private readonly config: PlatformConfigService) {}
  ...
  execute(
    ...
    if (operation === 'acceptAdminInvitation' && !this.config.get('MASARIFI_ADMIN_ROUTES_ENABLED')) {
      throw new HttpException({code:'NOT_FOUND'},404);
    }
    return this.security.execute({
      operation,
      permission: SECURITY_ROUTES.find((candidate) => candidate.operation === operation)?.permission,
...
for (const route of SECURITY_ROUTES) {
  ...
  methodDecorators[route.method](route.path)(SecurityController.prototype, route.operation, descriptor);
  HttpCode(route.status)(SecurityController.prototype, route.operation, descriptor);
  ApiOperation({ operationId: route.operation })(SecurityController.prototype, route.operation, descriptor);
  ApiBearerAuth('ClerkBearer')(SecurityController.prototype, route.operation, descriptor);
  if (route.permission) {
    adminPermission(route.permission, { recentMfa: route.recentMfa })(SecurityController.prototype, route.operation, descriptor);
