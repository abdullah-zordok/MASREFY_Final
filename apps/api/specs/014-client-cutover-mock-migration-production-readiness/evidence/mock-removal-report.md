...
| Mobile ledger/sync (Wave 3 pending) | Production core-finance composition is live, but unsupported ledger operations currently fail explicitly; BE006 runtime replay is not yet wired | Complete BE005 transactions and BE006 runtime coordination in Wave 3; retain owner-scoped SQLite drafts, queue, conflicts and local preferences |
