...
const CANONICAL_CLIENT_PERMISSION: Readonly<Record<string, PermissionKey>> = {
  "access.invites.write": "admin-team.invite",
  "access.roles.read": "roles.read",
  "access.roles.write": "roles.manage",
