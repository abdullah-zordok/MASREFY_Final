...
- **Platform behavior**: [Android and iOS behavior, permission path, and manual fallback]
- **Financial trust**: [record effects, confirmation, undo/correction, and sensitive data]
