...
select is((select count(*) from public.notification_templates where system_seed and status='published'),156::bigint,'reviewed source-event templates cover locale and channel matrix');
